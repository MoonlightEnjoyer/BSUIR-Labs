...
shippers = generate_shippers(15)
customers = generate_customers(15)
warehouses = generate_warehouses(15, suppliers)
freights = generate_freights(15, customers)
drivers = generate_drivers(15, freights, shippers)
trucks = generate_trucks(15, drivers)
